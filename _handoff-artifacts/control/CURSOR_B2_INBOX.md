...
state: PREPARED
lane: B2
task-key: SPRINT2-WIREFRAME-BROWSER-ACCEPTANCE-B2-20260920-R3
mode: WIREFRAME_BROWSER_ACCEPTANCE
updatedAt: 2026-09-20T03:22:00+09:00
sprint: Sprint2
priority: IMMEDIATE
instruction-path: _handoff-artifacts/tasks/SPRINT2-WIREFRAME-BROWSER-ACCEPTANCE-B2-20260920-R3/instruction.md
...
recovery: ROLE2_DISPATCH_CANONICAL_B2_R3
pickup-requirements:
...
- publish terminal result to GitHub canonical R3 result path with exact HEAD, clean-tree status, command and pass count
