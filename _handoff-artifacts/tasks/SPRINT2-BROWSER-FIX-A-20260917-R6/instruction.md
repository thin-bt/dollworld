# SPRINT2-BROWSER-FIX-A-20260917-R6
...
predecessor: SPRINT2-BROWSER-FIX-A-20260917-R5
recovery: PM_FAILOVER_STALE_PREPARED_R5_NO_ACTIVE_OR_TERMINAL
...
## Terminal contract
Claim ACTIVE before source changes. Publish `_handoff-artifacts/results/SPRINT2-BROWSER-FIX-A-20260917-R6/result.md` with exact HEAD/worktree binding, changed files, commands/pass-fail counts, remaining Sprint2 gaps, READY or FIX_REQUIRED. On READY B2 runs fresh browser reacceptance.
