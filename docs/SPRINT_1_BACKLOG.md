...
- 対象ゲーム仕様：`SPEC-0.1.2`
- 対象Sprint 1ミニ仕様：`S1-SPEC-0.1.13`
- 仕様確定commit：`2800d3b959e575f57660c27b344507dd0e38ddb6`
- 実装状態：S01-001〜S01-004 **実装済み**、S01-005〜S01-009 **pending**（次の実装着手は S01-005）
...
- SimulationIdentity.specVersionsの必須値（`SPEC-0.1.2`／`S0-SPEC-0.1.5`／`S1-SPEC-0.1.13`）
...
- 新機能の追加実装（欠陥修正に限る）
- 大会・昇格・賞金・Web・MySQL
- 仕様08〜14の内容変更や`S1-SPEC-0.1.13`の版上げ
