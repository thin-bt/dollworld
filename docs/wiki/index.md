...
Sprint 1 仕様現行版: `S1-SPEC-0.1.20`（`0.1.11` 確定 commit `2800d3b959e575f57660c27b344507dd0e38ddb6`、`0.1.19` はpost-start abort、`0.1.20` はS01-008 integration contracts）。Sprint 1全体の実装は未完了（S01-001〜008 implemented / accepted、S01-009 pending／未着手）。
