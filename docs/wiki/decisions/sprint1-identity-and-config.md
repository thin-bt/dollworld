...
- 戦闘開始`sourceSnapshot` baselineにより戦闘中も`sourceSnapshotHash`を常時検証する。BattleState schema現行は`0.6.0`（14・11／`S1-SPEC-0.1.17`）。Sprint1 identity現行版は`S1-SPEC-0.1.19`
