...
Sprint 0・Sprint 1を横断するアーキテクチャ索引。Sprint 0は実装済み配置と責務分割、Sprint 1は仕様確定済みの処理境界と戦闘ライフサイクルを区別する（S01-001〜003実装済み、次はS01-004）。詳細は TECHNICAL_DECISIONS・正式ミニ仕様・コードを正とする。
