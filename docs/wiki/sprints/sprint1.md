...
- Sprint 1全体は**未完了**
- S01-001〜S01-003は実装済み。次の実装着手はS01-004
...
- `packages/simulation-core/src/sprint1/`（S01-001〜003の公開型・validation・カタログ／成長API）
...
- 次の実装着手は S01-004（週間Processor）。Sprint 1全体は未完了
