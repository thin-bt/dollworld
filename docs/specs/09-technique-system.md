...
| mastery | 係数 | 設定キー |
|---|---:|---|
| 0..39 | 1.00 | `mastery0to39` |
| 40..59 | 0.80 | `mastery40to59` |
| 60..79 | 0.55 | `mastery60to79` |
| 80..89 | 0.25 | `mastery80to89` |
| 90..100 | 0.10 | `mastery90to100` |

設定キー `techniqueLearning.masteryCurrentValueFactors` で管理する。戦闘使用による上昇でも同じ係数表を用いる（適用順は13§8.2）。
