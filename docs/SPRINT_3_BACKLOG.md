...
| S03-060 | Post-S03-058 current-master root gate（B2） | `SPRINT3-S03-060-POST-S03-058-CURRENT-MASTER-ROOT-GATE-B2-20260922-R1` @ `4ed0cf4` | **READY** — **1915/1915** @ tested tip；post-**`47104c3`** gate 正本（pre-S03-063 歴史；current-tip binding は **S03-064**） |
...
| S03-064 | Post-S03-063 current-master root gate（B2） | `SPRINT3-S03-064-POST-S03-063-CURRENT-MASTER-ROOT-GATE-B2-20260922-R1` @ `c0c9754` | **READY** — **1925/1925** @ tested tip；post-**`46225f4`** gate 正本 |
