...
export const SIMULATION_IDENTITY_SCHEMA_VERSION = "0.6.0" as const;
...
export const DERIVED_TIE_KEY_POLICY_VERSION_FOR_IDENTITY = "derived-tie-key-0.1.0" as const;
...
export const RUN_RULE_SNAPSHOT_SCHEMA_VERSION = "0.6.0" as const;
